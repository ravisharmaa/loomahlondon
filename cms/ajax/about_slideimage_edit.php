...
<div class="container" style="margin:0;">
    ...
    <div class="info">
        Provide the slide image you wish to update.
    </div>
	...
	if(empty($row_slide['slideshow_image']))
	{
        ...
        <tr>
            ...
            <td class="formright"><input type="file" id="slideshow_image" name="slideshow_image" value="" />
                                 	 <br />
       		 <b>The uploaded image will appear as slideshow on the about page.
           ...
           $decorative_p_id=3;
				...
				?>
                        <select name="slideshow_link" class="selecting_val myselectbox" style="width:160px;">
                           <option value="index" <?php if($row_slide['slideshow_link']=="home") echo "selected"; ?>>Home Page</option>
