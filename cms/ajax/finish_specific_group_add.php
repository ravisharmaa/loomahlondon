...
{
	$finishes->addFinishSpecificGroups();
	exit;
}
?>
<h2>Add new finishes specific group</h2>
<div class="clearboth"></div>
<div class="container" style="margin-top:10px;padding:0 10px 10px;">
	<div class="info">Provide a name for the finishes specific group that you wish to add.</div>
    <form id="furniture_specific_group_add">
    <table border="0" class="myform">
    <tr>
        <td class="formleft">Furniture specific group</td>
        <td class="formright"><input type="text" name="furniture_specific_group_name" class="mytextbox" value="" /></td>
    </tr>
    </table>
                                ...
                                <li style="margin:0;">
                                    <div class='mybb' style="width:185px;">
                                        ...
                                        <div class="finishes-btns" style="height:15px; width:153px;">
                                            <input type="checkbox" name="finish_product_id[]" value="<?php echo $row_product['product_id']; ?>" <?php //if ($count_product > 0) { echo "checked";   } ?> />
                                        </div>
                                    </div>
                                </li>
                                <?php
	...
	$(function(){
		$('#saveit').click(function(){
			...
			$('.saving').show();
			$.ajax({
				url: 'ajax/finish_specific_group_add.php',
				type: 'post',
