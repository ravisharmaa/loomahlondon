...
$row_content=$cnt->getFeaturedPageContent($row_slide['content_id']);
?>
<div class="container" style="margin:0;">
    <h1>Edit an image</h1>
    <div class="clearboth"></div>
    <div class="info">
        Provide the caption and the image you wish to update.
    </div>
    ...
    <tr>
        ...
        <td class="formright"><input type="text" name="slideshow_desc" class="mytextbox" value="<?php echo stripslashes($row_slide['slideshow_desc']); ?>"></td>
    </tr>
	...
	if(empty($row_slide['slideshow_image']))
	{
        ...
        <tr>
            ...
            <td class="formright"><input type="file" id="slideshow_image" name="slideshow_image" value="" />
                                 	 <br />
       		 <b>The uploaded image will appear as on the <?php echo strtolower(stripslashes($row_content['content_title']));  ?> page.
            <br /> The dimensions of the image should be <?php echo GALLERY_IMG_W; ?> px in width.
            <br />The height may vary with a maximum height of <?php echo GALLERY_IMG_H; ?> px. For example a wider (landscape shaped) product may not required as much height as a square shaped product or portrait shaped product. 
	...
	?>
    	...
    	<?php
	if(empty($row_slide['slideshow_image_lg']))
	{
		?>
        <tr>
            <td class="formleft">Upload Large Image</td>
            <td class="formright"><input type="file" id="slideshow_image_lg" name="slideshow_image_lg" value="" />
                                 	 <br />
       		 <b>The uploaded image will appear on the <?php echo strtolower(stripslashes($row_content['content_title']));  ?> page.
            <br /> The dimensions of the image should be <?php echo GALLERY_IMG_W_LG; ?> px in width.
            <br />The height may vary with a maximum height of <?php echo GALLERY_IMG_H_LG; ?> px. For example a wider (landscape shaped) product may not required as much height as a square shaped product or portrait shaped product. 
	...
	else
	{
    	...
    	<tr>
            ...
            <td class="formright"><img src="../<?php echo SLIDE_IMG_LG.$row_slide['slideshow_image_lg']; ?>" width="200" /></td>
        </tr>
		<tr>
            <td class="formleft"></td>
            <td class="formright"><input type="file" id="slideshow_image_lg" name="slideshow_image_lg" />         	 <br />
       		 <b>The uploaded image will appear on the <?php echo strtolower(stripslashes($row_content['content_title']));  ?> page.
                <br /> The dimensions of the image should be <?php echo GALLERY_IMG_W_LG; ?> px in width.
            <br />The height may vary with a maximum height of <?php echo GALLERY_IMG_H_LG; ?> px. For example a wider (landscape shaped) product may not required as much height as a square shaped product or portrait shaped product 
             <br />If you decide to upload a new image, it will replace the existing one. 
	...
	$(function(){
		$('.slide_edit').click(function(){
			...
			$('.saving').show();
			$.ajax({
				url: 'ajax/gallery_slideimage_edit.php',
				type: 'post',
				data: $('#form_slide_edit').serialize(),
				success: function(){
				$("#slideshow_image_lg").upload("ajax/about_slideimage_upload.php?id=<?php echo $slideshow_id; ?>",function(res){
					},function(data) {
					});
				
					$("#slideshow_image").upload("ajax/about_slideimage_upload.php?id=<?php echo $slideshow_id; ?>",function(res){
						$('.saving').hide();
						$.fancybox.close();	
					},function(data) {
					});
