		...
		foreach($row_slides as $row_slide)
		{
            ...
            <li id="sortdata_<?php echo $row_slide['slideshow_id']; ?>">
                <div class="polaroidimg">
                    <a href="ajax/home_slideimage_edit.php?id=<?php echo $row_slide['slideshow_id']; ?>" class="slide_edit_link fancybox.ajax"><img src="../<?php echo SLIDE_IMG.$row_slide['slideshow_image']; ?>" width="200" border="0" /></a>
                </div>
