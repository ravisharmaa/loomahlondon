...
?>
		...
		<select name="slideshow_link"  class="selecting_nextval myselectbox" style="width:200px;">
        	...
        	<select name="slideshow_link"  class="myselectbox" style="width:200px;">
             ...
             if(count($row_products))
			 {
				 foreach($row_products as $row_product)
				 {
                    ...
                    ?>
                    <option value="<?php echo stripslashes($p_alias); ?>/<?php echo stripslashes($cat_alias); ?>/<?php echo stripslashes($row_product['product_alias']); ?>"><?php echo stripslashes($row_product['product_name']); ?></option>
                    <?php
                }
            }
            ?>
