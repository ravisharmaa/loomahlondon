                ...
                <div id="cat_<?php echo $row_cat['cat_id']; ?>" class="tabblock1" style="display:none;">
                    <ul id="mysorter">
                        ...
                        if(count($row_products))
                        {
                            ...
                            {
                                $check=$pro->isCompatible($product_id,$row_product['product_id'],0); 
								if(!$check)
								{
								?>
                                <li style="margin:0;">
                                    ...
                                    <div style="border:#DDD 1px solid;border-top:none;background:#EEE;padding:10px;margin:0 5px;">
                                        <table>
                                        <tr>
                                        	<td width="20" valign="top"><input type="checkbox" name="interested_product_id[<?php echo $row_product['product_id']; ?>][0]"  /></td>
                                            <td>
                                            	<?php echo substr(stripslashes($row_product['product_name']),0,25); ?>
                                    			<br />
                                            </td>
                                       	</tr>
                                        </table>     
                                ...
                                if(count($row_images))
                                {
                                    ...
                                    {
										$check_available=$pro->isCompatible($product_id,$row_product['product_id'],$row_image['alt_image_id']);
										if(!$check_available)
										{
                                        ?>
                                        <li style="margin:0;">
                                            ...
                                            <div style="border:#DDD 1px solid;border-top:none;background:#EEE;padding:10px;margin:0 5px;">
                                                <table>
                                                <tr>
                                                	<td width="20" valign="top"><input type="checkbox" name="interested_product_id[<?php echo $row_product['product_id']; ?>][<?php echo $row_image['alt_image_id']; ?>]" value="<?php echo $row_image['alt_image_id']; ?>"/></td>
                                                    <td>
                                                    	<?php echo substr(stripslashes($row_product['product_name']),0,25); ?>
                                    					<br /> <?php echo substr(stripslashes($row_image['alt_img_name']),0,25); ?>
                                            		</td>
                                               	</tr>
                                                </table>     
                                            </div>
