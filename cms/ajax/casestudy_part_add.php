...
else
{
	...
	$casestudy_part_type=$_REQUEST['type'];
	?>
    <div class="container" style="margin:0;">
		...
		if($casestudy_part_type=="Title")
		{
			...
			$(function() {
				...
				$('.save').click(function(){
					...
					$.ajax({
						type: "POST",
						url: 'ajax/casestudy_part_add.php',
            ...
            <tr>
                ...
                <td class="formright"><input type="text" name="casestudy_part_data1" value="" class="mytextbox" /><br />Provided text appears as the title slightly bigger and bolder font face than regular text.</td>
            </tr>
        	<tr>
                <td class="formleft">Title Alignment</td>
                <td class="formright">
            		<label><input type="radio" name="casestudy_part_data3" value="left" checked /> Left</label>
            		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><input type="radio" name="casestudy_part_data3" value="center" /> Center</label>
            		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><input type="radio" name="casestudy_part_data3" value="right" /> Right</label>
		...
		else if($casestudy_part_type=="Text")
		{
            ...
            <tr>
                ...
                <td class="formright"><textarea name="casestudy_part_data1" class="myeditor"></textarea></td>
            </tr>
        	<tr>
            	<td class="formleft">&nbsp;</td>
				<td class="formright">
		...
		else if($casestudy_part_type=="Image")
		{
            ...
            <tr>
                ...
                <td class="formright">
                	<label><input type="radio" name="casestudy_part_data3" value="left" /> Left</label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><input type="radio" name="casestudy_part_data3" value="center" checked /> Center</label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><input type="radio" name="casestudy_part_data3" value="right" /> Right</label>
            ...
            <tr>
                ...
                <td class="formright"><input type="text" name="casestudy_part_data1" class="mytextbox" /></td>
            </tr>
        	<tr>
            	<td class="formleft">&nbsp;</td>
				<td class="formright">
		...
		else if($casestudy_part_type=="TextImage")
		{
            ...
            <tr>
                ...
                <td class="formright">
                	<label><input type="radio" name="casestudy_part_data3" value="left" checked /> Left</label>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><input type="radio" name="casestudy_part_data3" value="right" /> Right</label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><input type="radio" name="casestudy_part_data3" value="top" /> Top</label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><input type="radio" name="casestudy_part_data3" value="bottom" /> Bottom</label>
		...
		else if($casestudy_part_type=="Gallery")
		{
			...
			$(function() {
				...
				$('.save').click(function(){
					...
					$.ajax({
						...
						data: $('#casestudy_paragraph_form').serialize(),
						success: function(data){
							$('#casestudy_part_id').val(data);
							$("#casestudy_part_image").upload("ajax/casestudy_part_gallery_upload.php?id="+data,function(res) {
								$.ajax({
			...
			*/ ?>
			...
			<input type="hidden" id="casestudy_part_id" name="casestudy_part_id" value="" />
			<?php
		}
		else if($casestudy_part_type=="Link")
		{
            ...
            <tr>
                ...
                <td class="formright"><input type="text" name="casestudy_part_data1" value="" class="mytextbox" />
            ...
            <tr>
                ...
                <td class="formright">
                	<label><input type="radio" name="casestudy_part_data2" value="I" class="link_to" checked /> Internal Page</label>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <label><input type="radio" name="casestudy_part_data2" value="E" class="link_to" /> External Page</label>
               ...
               <select name="casestudy_part_data3" style="width:300px;">
                ...
                <option value="other-services">Other Services</option>
                    ...
                    <div id="external_link" style="display:none;">
                        <b>URL:</b> <input type="text" name="casestudy_part_data4" value="" placeholder="http://" style="width:85%;" />
		...
		else if($casestudy_part_type=="File")
		{
            ...
            <tr>
                ...
                <td class="formright"><input type="text" name="casestudy_part_data1" class="mytextbox" />
		...
		else if($casestudy_part_type=="Video")
		{
			...
			<tr>
                ...
                <td class="formright">www.youtube.com/watch?v=<input type="text" name="casestudy_part_data5" class="mytextbox" style="width:300px;" />
		...
		else if($casestudy_part_type=="FAQ")
		{
            ...
            <tr>
                ...
                <td class="formright"><textarea name="casestudy_part_data1" class="mytextarea"></textarea></td>
			</tr>
			<tr>
                <td class="formleft">Answer</td>
                <td class="formright"><textarea name="casestudy_part_data2" class="mytextarea"></textarea></td>
			</tr>
			<tr>
				<td class="formleft">&nbsp;</td>
                <td class="formright">
		...
		?>
		<input type="hidden" name="casestudy_part_type" value="<?php echo $casestudy_part_type; ?>" />
