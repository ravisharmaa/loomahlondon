...
if(isset($_REQUEST['p_id']))
{
	switch($_REQUEST['p_id'])
	{
		case "manage_subscribers":
			$page_link="manage_subscribers.php";
			break;
		case "manage_deliverycharges":
			$page_link="manage_deliverycharges.php";
			break;
			
		case "manage_pricelist":
			$page_link="manage_pricelist.php";
			break;
		
		case "manage_instagram":
			$page_link="manage_instagram.php";
			break;
		case "manage_resources":
			$page_link="manage_resources.php";
			break;
			case "manage_resource":
			$page_link="manage_resource.php";
			break;
	
		case "manage_sales":
			$page_link="manage_sales.php";
			break;
	
		case "manage_wallpapers":
			$page_link="manage_categories.php";
			break;
		case "manage_decorative_pieces":
			$page_link="manage_categories.php";
			break;
		case "manage_textiles":
			$page_link="manage_categories.php";
			break;
		case "manage_gallery":
			$page_link="manage_gallery.php";
			break;
...
<head>
	...
	?>
    <script src="freeckeditor/ckeditor.js" type="text/javascript"></script>
    <script src="freeckeditor/adapters/jquery.js" type="text/javascript"></script>
