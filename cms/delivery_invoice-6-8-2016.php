...
<tr>
	<td align="center" class="invoice" style="color:#c1c1c1; font-size:24px;" >INVOICE</td>
</tr>
</table>
...
<tr>
    ...
    <tr>
        ...
        <td  align="left"  class="pad-left"><?php $o_date = strtotime($row_sale['sale_date']); echo date("F j Y",$o_date); ?></td>
    </tr>
 	<tr>
...
<tr>
			...
			foreach($row_orders as $row_order)
			{
                ...
                <td align="left"  style="border-bottom:none;">
                  ...
                  if($colourways_id!=0)
                    ...
                    <?php echo $row_product['product_name']." - ".$products_colourways['colourways_img_name']; ?>
                	<?php
                  	}
                 	else
                 	{
    ...
    <tr  class="border">
     ...
     <tr>
        <td colspan="2"  style="border-bottom:none; border-left:none;" class="font-colour " >Please email advice of remittance to: sales@nicolalawrence.com.au</td>
        <td  align="right" class="border font-colour">Delivery:</td>
        <td align="right"  class="border"><?php echo sprintf("%0.2f",$total_delivery); ?></td>
    </tr>
     <tr>
       
          <td colspan="2" style="border-bottom:none; border-left:none;" class="font-colour" >EFT or Direct Debit to: Nicola lawrence, BSB:062 500, Acc No 10089725</td>
...
<table border="0" width="600" style="min-height:800px;" align="center">
<tr>
	<td style="text-align:center; color:#9a9a9a; ">Formosa, Hay, NSW, 2711 <span style="color:#E3158F;">|</span> Tel: +61 438 266133 <span style="color:#E3158F;">|</span> Email: info@nicolalawrence.com.au <span style="color:#E3158F;">|</span> ABN: 13 584 735 714</td>
</tr> 
<tr>
	<td style="text-align:center">&nbsp;</td>
</tr>     
