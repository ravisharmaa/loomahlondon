    ...
    <table border="0" class="myform">
      ...
      <tr>
        ...
        Minimum Order
             ...
             <select name="min_purchase_order" style="min-width:70px;" >
			  <?php
                for ($x = 1; $x <= 10; $x += 0.5 )
				 {
                ?>
                 <option style="padding:3px 6px;" <?php if($x==$row_order_qty['min_purchase_order']) echo "selected"; ?> value="<?php  echo $x; ?>"> <?php  echo $x; ?></option>
                <?php
                }
                ?>
        	</select>
                     &nbsp; &nbsp; &nbsp; Increments Thereafter 
              <select name="purchase_order_increament" style="min-width:70px;">
		  <?php
            for ($x = 0; $x <= 10; $x += 0.5)
			 {
            ?>
            <option style="padding:3px 6px;" <?php if($x==$row_order_qty['purchase_order_increament']) echo "selected"; ?> value="<?php  echo $x; ?>"><?php  echo $x; ?> </option>
			<?php
            }
            ?>
        </select>
            ...
            &nbsp; &nbsp; &nbsp; Maximim Order
              <select name="max_purchase_order" style="min-width:70px;">
		  <?php
            for ($x = 0.5; $x <= 10; $x += 0.5)
			 {
            ?>
            <option style="padding:3px 6px;" <?php if($x==$row_order_qty['max_purchase_order']) echo "selected"; ?> value="<?php  echo $x; ?>"><?php  echo $x; ?> </option>
			<?php
            }
            ?>
        </select>
        ...
        Minimum Order
             ...
             <select name="min_sample_order" style="min-width:70px;" >
			  <?php
                for ($x = 1; $x <= 6; $x ++)
				 {
                ?>
                ...
                ?>
                     ...
                     &nbsp; &nbsp; &nbsp; Increments Thereafter 
              <select name="sample_order_increament" style="min-width:70px;">
		  <?php
             for ($x = 0; $x <= 6; $x ++)
			 {
            ?>
            ...
            &nbsp; &nbsp; &nbsp; Maximim Order
              <select name="max_sample_order" style="min-width:70px;">
		  <?php
             for ($x = 1; $x <= 6; $x ++)
			 {
            ?>
...
<div class="accordion"><a href="JavaScript:void(0);" rel="multi_dimension" class="accordiontab">CLICK HERE TO ADD OR EDIT THE MULTI DIMENSIONS FOR THIS PRODUCT</a></div>
      ...
      <div id="multi_dimension_block" style="padding:10px 15px 20px 15px;">
          <form action="" method="post" enctype="multipart/form-data">
                  <table border="0" class="myform">
                      ...
                      <tr>
                       <td class="formleft">
                        ...
                        <td class="formright">    
                                    ...
                                    <table class="myform">
                                    <tr>
                                     <td class="formright">Dimension</td>
                                     <td class="formright">Price </td>
                                     <td class="formright">Delivery Price</td>
                                     <td class="formcenter">Action</td>
                                    </tr>
                                    <?php
                    ...
                    <tr>
                        <td class="formleft">Dimension</td>
                        <td  class="formright"><input  id='dimension' type="text" name="dimension" class="mytextbox"  /></td>
                    </tr>
                    <tr>
