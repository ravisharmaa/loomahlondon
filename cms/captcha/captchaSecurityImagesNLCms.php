...
/*
* File: CaptchaSecurityImagesNLCms.php
* Author: Simon Jarvis
...
class CaptchaSecurityImagesNLCms {
	...
	function CaptchaSecurityImagesNLCms($width='120',$height='30',$characters='4') {
		...
		$text_color = imagecolorallocate($image, 42, 42, 42);
		...
		imagejpeg($image);
		imagedestroy($image);
		$_SESSION['security_code_cms'] = $code;
...
$captcha = new CaptchaSecurityImagesNLCms($width,$height,$characters);
