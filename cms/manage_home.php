...
<div class="info">
    ...
    <tr>
       <!-- <td class="formleft" style="width:50%">Title</td>-->
        ...
        <textarea type="text" name="content_desc"  class="myeditors" style="width:99%; height:30px; font-weight:bold; text-transform: uppercase; color:#2a2a2a;font-family: "BrandonGM";"><?php echo stripslashes($row_content['content_desc']); ?></textarea>
        </td>
    </tr>
