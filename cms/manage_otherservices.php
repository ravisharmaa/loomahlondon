...
<div class="breadcrumb">
	<a href="login.php">Dashboard</a> &raquo; Other Services
</div>

<div class="accordion"><a href="JavaScript:void(0);" rel="page_content" class="accordiontab" <?php if(isset($show_tab) and $show_tab=="page_content") echo "style='background: url(images/tgup.png) no-repeat right #E30B5D;'"; ?>>CLICK HERE TO CHANGE BANNER AND HEAD PARAGRAPH FOR THE OTHER SERVICES PAGE</a></div>
<div id="page_content" class="accordionblock" style="display:<?php echo (isset($show_tab) and $show_tab=="page_content")?"block":"none"; ?>;">
	...
	if(empty($row_content_banner['content_banner_image']))
	{
        ...
        <tr>
            ...
            <b class="line_height"><br />The uploaded image will appear on the top of other services page.
...
<div class="accordion"><a href="JavaScript:void(0);" rel="sub_pages" class="accordiontab" <?php if(isset($show_tab) and $show_tab=="sub_pages") echo "style='background: url(images/tgup.png) no-repeat right #E30B5D;'"; ?>>CLICK HERE TO MANAGE THE SUB-PAGES FOR THE OTHER SERVICES PAGE</a></div>
...
<div class="accordion"><a href="JavaScript:void(0);" rel="page_seo" class="accordiontab" <?php if(isset($show_tab) and $show_tab=="page_seo") echo "style='background: url(images/tgup.png) no-repeat right #E30B5D;'"; ?>>CLICK HERE TO EDIT SEO FOR THE OTHER SERVICES PAGE</a></div>
