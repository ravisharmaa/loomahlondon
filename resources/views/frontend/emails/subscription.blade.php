    ...
    <table width='600' align='center' cellpadding='0' cellspacing='0' border='0' style='background:#F7F7F7;margin:0 auto;'>
        <tr>
            <td valign='top' align='center' style='padding: 20px 0;'>
                <img src="{{asset('assets/frontend/img/mp-logo.png')}}" alt='Marcus Paul' width='120' border='0' /><br><br>
            </td>
        </tr>
        <tr>
            <td><div style='border-top:#AFD7DF 1px solid'>&nbsp;</div></td>
        </tr>
        <tr>
            <td style='padding:20px;font-size:11px;line-height:16px;'>
                Dear {{$data['fullname']}},
                <br /><br />
        ...
        <tr>
            <td><div style='border-bottom:#AFD7DF 1px solid'>&nbsp;</div></td>
        </tr>
        <tr>
